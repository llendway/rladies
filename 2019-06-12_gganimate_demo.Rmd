...
Let's look at a simple plot that shows the distribution of *mpg* by cylinder.
...
Now, let's try one of the plots Pedersen created. Notice that it takes awhile to run. Then it displays it over in the viewer, rather than beneath the code, like we're used to. 
...
include_graphics("/Users/llendway/GoogleDriveMacalester/2019SPRING/MATH112/notes_r_code/Images/boxplots.gif")
```
